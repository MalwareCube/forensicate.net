...
After you've pulled your threat intelligence together and profiled the adversary, you've got a hypothesis you want to hunt for. You know exactly what you're looking for, but when you sit down to query your environment, you realise you can't. The data just isn't there. 
...
- The normalisations and filters that make the signal readable
...
Yes, of course. Sometimes you *actually* find something. It happens, and when it does, you kick off the incident response process. There is often not much time to pat yourself on the back. This is the outcome most people picture when they hear "threat hunting".
...
Programs that only report the third number are more likely to get cut during the first cost-pressure cycle. Programs that report all three will more likely be recognised as the compounding investment they actually are.
...
4. **Hunt.** Query, transform, and stack the data by a pivot that maps to your hypothesis. Characterise what's normal and start pulling the threads of what isn't.
...
Every one of those questions is a potential **gap finding**. And every successful pattern you characterise is a candidate for an automated detection.
