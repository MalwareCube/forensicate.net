...
[CBS Forensic Toolkit](https://github.com/exfiltrace-labs/cbs_parser) extracts three such artifact sources from the CBS package, each with meaningful forensic value.
